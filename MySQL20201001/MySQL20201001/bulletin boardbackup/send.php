...
// if (isset($_SERVER['HTTP_X_REQUESTED_WITH']) && strtolower($_SERVER['HTTP_X_REQUESTED_WITH']) == 'xmlhttprequest') {
  ...
  // }else{
    ...
    // echo $reslt;
    // echo '<div data-comment = "'.$comment.'"></div>';
    // echo '<div data-datetime = "'.$datetime.'"></div>';
    echo '<div id="wrap">';
    ...
    // echo $comment;
    // echo $datetime;
    // echo '<option value="青森県" data-val="北海道・東北">青森県</option>';
    // echo '<div data-comment = "'.$comment.'" data-datetime = "'.$datetime.'"></div>';
